...
// ---------------------------------------------------------------------------------------------------------------------
// Mining Module!
    let minerCreepPosition = 'emptyPosition'

    let W1N6_Miners = 'empty';
    let W2N6_Miners = 'empty';
    ...
    switch (true) {
        case W1N6_Miners !== 'empty':
            minerCreepPosition = W1N6_Miners;
            break;

        case W2N6_Miners !== 'empty':
            minerCreepPosition = W2N6_Miners;
            break;

        default:
            break;

    } // Redirect position by rooms
